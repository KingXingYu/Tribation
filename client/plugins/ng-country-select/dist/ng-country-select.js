(function() {
  ...
  angular.module('countrySelect', []).directive('countrySelect', function() {
    ...
    return {
      ...
      template: '<select ng-options="country.code as country.name for country in countries"> <option value="" disabled selected">Country</option><option value="" ng-if="isSelectionOptional"></option> </select>',
      controller: [
